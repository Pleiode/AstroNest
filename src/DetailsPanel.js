...
const DetailsPanel = ({ selectedImage, handleDelete, handleInputChange, formatDate, handleBrutFileChange, selectedImages }) => {
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    <div className="file-upload-container">
                                        ...
                                        <img style={{ width: '50px' }} src={selectedImage.brutPath}>
                                        </img>

                                        <span className="file-name">{selectedImage.brutPath.split('/').pop()}</span>
